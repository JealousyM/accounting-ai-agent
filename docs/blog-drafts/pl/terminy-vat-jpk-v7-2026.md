...
category: VAT
tags: [vat, jpk_v7, terminy, deklaracja]
...
1. Czym jest JPK_V7 — ewidencja i deklaracja w jednym pliku
2. JPK_V7M czy JPK_V7K — miesięcznie czy kwartalnie
3. Podstawowy termin — do 25. dnia miesiąca
4. Rozliczenie kwartalne małego podatnika
5. Gdy 25. wypada w weekend lub święto
6. Kalendarz terminów VAT/JPK_V7 na 2026
7. Informacja podsumowująca VAT-UE
8. Co grozi za spóźnienie — odsetki i czynny żal
9. Jak nie przegapić terminu
10. FAQ

## 1. Czym jest JPK_V7 — ewidencja i deklaracja w jednym pliku

**JPK_V7** to jednolity plik kontrolny, który zastąpił dawne deklaracje VAT-7 i osobne pliki JPK_VAT. Od tamtej pory jeden dokument łączy dwie części:

- **Część ewidencyjną** — szczegółowy zapis wszystkich faktur sprzedaży i zakupu (kto, kiedy, na jaką kwotę, z jakimi oznaczeniami GTU i kodami procedur),
- **Część deklaracyjną** — zbiorcze rozliczenie podatku należnego i naliczonego, czyli wyliczenie kwoty VAT do zapłaty lub do zwrotu.
...
Formę pliku wybierasz zależnie od tego, jak rozliczasz VAT:
...
Reguła jest jedna i wspólna dla płatności oraz wysyłki pliku:

> **JPK_V7 wysyłasz i VAT płacisz do 25. dnia miesiąca następującego po okresie rozliczeniowym.**

Przy rozliczeniu miesięcznym oznacza to np., że **za czerwiec 2026** komplet JPK_V7M i przelew podatku muszą trafić do urzędu **do 25 lipca 2026** (a ponieważ ten dzień wypada w sobotę — realnie do 27 lipca; więcej w sekcji 5).

Ważne rozróżnienie: **termin wysyłki pliku i termin płatności to ten sam dzień**, ale to dwie odrębne czynności. Można wysłać plik na czas, a spóźnić się z przelewem — i odwrotnie. Obie sytuacje rodzą konsekwencje, więc warto pilnować ich razem.

VAT wpłacasz na swój **indywidualny mikrorachunek podatkowy** (ten sam, na który idą PIT i CIT), a nie na ogólne konto urzędu.

## 4. Rozliczenie kwartalne małego podatnika

Przy JPK_V7K rytm jest nieco inny — ewidencja „żyje" co miesiąc, a deklaracja domyka kwartał:

- za **pierwszy i drugi miesiąc** kwartału wysyłasz JPK_V7K zawierający **tylko część ewidencyjną** (bez płatności podatku),
- za **trzeci miesiąc** kwartału wysyłasz JPK_V7K z **ewidencją tego miesiąca oraz częścią deklaracyjną za cały kwartał** — i wtedy **płacisz VAT** za trzy miesiące łącznie.

Terminy pozostają przy 25. dniu miesiąca. Deklaracja za dany kwartał (i płatność) przypada więc do 25. dnia miesiąca **po zakończeniu kwartału**:

- **I kwartał** (styczeń–marzec) → do 25 kwietnia,
...
Zaleta jest oczywista — VAT płacisz cztery razy w roku, a nie dwanaście, co poprawia płynność. Wada: kwartalna kumulacja podatku bywa dużym jednorazowym obciążeniem, więc kwotę warto „odkładać" co miesiąc.
...
|---|---|---|
| Grudzień 2025 | 26 stycznia 2026 (pon.) | IV kw. 2025 → 26 stycznia 2026 |
| Styczeń 2026 | 25 lutego 2026 (śr.) | tylko ewidencja |
| Luty 2026 | 25 marca 2026 (śr.) | tylko ewidencja |
| Marzec 2026 | 27 kwietnia 2026 (pon.) | I kw. 2026 → 27 kwietnia 2026 |
| Kwiecień 2026 | 25 maja 2026 (pon.) | tylko ewidencja |
| Maj 2026 | 25 czerwca 2026 (czw.) | tylko ewidencja |
| Czerwiec 2026 | 27 lipca 2026 (pon.) | II kw. 2026 → 27 lipca 2026 |
| Lipiec 2026 | 25 sierpnia 2026 (wt.) | tylko ewidencja |
| Sierpień 2026 | 25 września 2026 (pt.) | tylko ewidencja |
| Wrzesień 2026 | 26 października 2026 (pon.) | III kw. 2026 → 26 października 2026 |
| Październik 2026 | 25 listopada 2026 (śr.) | tylko ewidencja |
| Listopad 2026 | 28 grudnia 2026 (pon.) | tylko ewidencja |
| Grudzień 2026 | 25 stycznia 2027 (pon.) | IV kw. 2026 → 25 stycznia 2027 |

Kolumna „tylko ewidencja" oznacza, że kwartalny podatnik wysyła w tym miesiącu JPK_V7K bez części deklaracyjnej i **nie płaci** wtedy VAT — rozliczenie następuje na koniec kwartału.

## 7. Informacja podsumowująca VAT-UE

Jeśli prowadzisz transakcje wewnątrzwspólnotowe — **WDT** (dostawa towarów do UE), **WNT** (nabycie towarów z UE) lub wybrane usługi na rzecz kontrahentów z UE — masz dodatkowy obowiązek: **informację podsumowującą VAT-UE**.
...
Kalendarz VAT łatwo przeoczyć — zwłaszcza gdy 25. przesuwa się przez święta, a obok czekają terminy PIT, CIT i ZUS. [eKsięgowy AI](/) to asystent AI **zintegrowany z wFirma**, który pilnuje **kalendarza podatkowego** i przypomni o zbliżającej się płatności oraz wysyłce JPK_V7 (także przez powiadomienia w **Telegramie**). W rozmowie odpowie, **ile i do kiedy** masz zapłacić przy Twojej formie rozliczenia, **wystawi e-fakturę do KSeF**, **sprawdzi kontrahenta na białej liście** i **autouzupełni dane firmy po NIP z GUS**. Mniej pilnowania dat, zero kar za spóźnienie.
