...
import { declarationTools, Language } from './tools-config';

const languages: Language[] = ['en', 'pl', 'ru'];

test.describe('AI Tools - Declarations', () => {
  ...
  // Generate tests for each declaration tool in each language
  for (const tool of declarationTools) {
