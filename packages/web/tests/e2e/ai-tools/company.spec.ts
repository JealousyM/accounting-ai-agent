...
import { companyTools, Language } from './tools-config';

const languages: Language[] = ['en', 'pl', 'ru'];

test.describe('AI Tools - Company', () => {
  ...
  // Generate tests for each company tool in each language
  for (const tool of companyTools) {
