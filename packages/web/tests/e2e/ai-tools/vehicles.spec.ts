...
import { vehicleTools, Language } from './tools-config';

const languages: Language[] = ['en', 'pl', 'ru'];

test.describe('AI Tools - Vehicles', () => {
  ...
  // Generate tests for each vehicle tool in each language
  for (const tool of vehicleTools) {
