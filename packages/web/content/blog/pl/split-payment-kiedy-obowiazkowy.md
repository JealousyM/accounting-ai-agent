...
category: VAT
tags: [split payment, mpp, vat, załącznik 15]
...
1. **Wartość brutto faktury przekracza 15 000 zł** (lub równowartość w walucie obcej). Liczy się kwota brutto całej faktury, a nie pojedynczej pozycji.
2. **Na fakturze jest co najmniej jedna pozycja z załącznika nr 15** do ustawy o VAT — czyli tzw. towary i usługi „wrażliwe".
3. **Obie strony to podatnicy VAT** — jest to transakcja **B2B** (sprzedawca i nabywca prowadzą działalność gospodarczą).
...
Od faktury **powyżej 15 000 zł brutto**, o ile obejmuje co najmniej jedną pozycję z załącznika nr 15 i jest to transakcja B2B. Poniżej progu MPP jest dobrowolny.

**Czy muszę stosować MPP do każdej faktury powyżej 15 000 zł?**
