...
category: VAT
tags: [biala lista, vat, kontrahent, koszty uzyskania przychodu, zaw-nr, split payment]
...
1. **Brak kosztu uzyskania przychodu** — wydatku (w części zapłaconej na zły rachunek) nie zaliczysz do kosztów podatkowych. To realnie podnosi Twój podatek dochodowy.
2. **Odpowiedzialność solidarna w VAT** — jeśli kontrahent nie zapłaci należnego VAT od tej transakcji, fiskus może dochodzić go również od Ciebie.
...
1. Wejdź na **wyszukiwarkę białej listy** na stronie Ministerstwa Finansów.
2. Wpisz **NIP** kontrahenta (albo numer rachunku).
3. Sprawdź jego **status VAT** oraz czy **numer konta z faktury** znajduje się na liście.
4. **Zapisz potwierdzenie** — wyszukiwarka pozwala pobrać dowód weryfikacji z datą. To Twoje zabezpieczenie na wypadek kontroli.
...
**Od jakiej kwoty obowiązuje biała lista?**
